  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 mb-3">
        <div
          className={`w-10 h-10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform ${iconStyles[variant]}`}
        >
...
// ------------ DashboardHero with Alerts + Features ----------------
  ...
  const features = [
    {
      ...
      icon: AlertTriangle,
      description: 'Real-time alerts for nearby disasters and emergencies.',
      variant: 'emergency' as const,
    },
    {
      title: 'Location Assistance',
      icon: MapPin,
      description: 'Share your location with responders automatically.',
      variant: 'info' as const,
    },
    {
      title: 'Crisis Chatbot',
      icon: MessageCircle,
      description: 'Instant support and guidance via chatbot.',
      variant: 'info' as const,
    },
    {
      title: 'Safety Resources',
      icon: ShieldCheck,
      description: 'Guides, procedures, and safety tips.',
      variant: 'safety' as const,
    },
    {
      title: 'Community Support',
      icon: Heart,
      description: 'Mental health and support networks.',
      variant: 'safety' as const,
    },
    {
      title: 'Emergency Info',
      icon: Info,
      description: 'Evacuation and crisis response protocols.',
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold mb-1">Crisis Companion</h1>
              <p className="text-primary text-lg">Your safety network dashboard</p>
            </div>
          </div>

          <Link href="/user/event" className="item-center gap-2 ">
          <Button
            variant="secondary"
    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-3 py-3">
        ...
        <p className="text-primary text-sm">
          © {new Date().getFullYear()} Crisis Companion. Supporting communities in crisis.
        </p>
      </footer>
      </div>
    </div>
